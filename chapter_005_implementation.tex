...
\section{Webseite}
% mit cra erstellt, enthält nur unten beschriebene komponenten, zwei themes, tests und ein paar zusätzliche ui elemente zur steuerung des verhaltens (view mode, dark mode, edit mode)
