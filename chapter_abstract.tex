...
Webapplikationen (mobile Apps, SPA, ... \fixme{beispiel} \fixme{formulierung}) machen heute bereits einen sehr großen Teil häufig benutzter (\fixme{formulierung}) Software aus.
In Zukunft wird der Anteil von webbasierter Software im Vergleich zu traditioneller Software noch weiter zunehmen (\fixme{quelle}).
